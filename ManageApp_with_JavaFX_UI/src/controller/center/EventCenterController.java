...
public class EventCenterController extends Controller{
	...
	public void initialize(URL url, ResourceBundle resourceBundle){
		...
		searchChoice.valueProperty().addListener(actionEvent -> syncHint());
	...
	private void syncHint(){
		EventSearchProperty property = searchChoice.getValue();
		search.setPromptText(property.getHint());
	}
	...
	private void setUpTable(){
		...
		TableColumn<EventDTO, String> organizer = new TableColumn<>("Organizer");
		TableColumn<EventDTO, String> location = new TableColumn<>("Location");
		TableColumn<EventDTO, String> time = new TableColumn<>("Time");
		TableColumn<EventDTO, String> duration = new TableColumn<>("Duration");
		...
		eventTable.getColumns().add(organizer);
		eventTable.getColumns().add(location);
		eventTable.getColumns().add(time);
		eventTable.getColumns().add(duration);
