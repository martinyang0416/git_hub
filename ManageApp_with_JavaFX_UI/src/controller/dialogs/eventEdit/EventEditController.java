...
public class EventEditController extends Controller{
	...
	private static final String TALK_DETAIL_FXML          = "/javafx/dialog/eventEdit/detail/talkDetail.fxml";
	private static final String NON_SPEAKER_DETAIL_FXML   = "/javafx/dialog/eventEdit/detail/nonSpeakerDetail.fxml";
	private static final String MULTI_SPEAKER_DETAIL_FXML = "/javafx/dialog/eventEdit/detail/multiSpeakerDetail.fxml";
	...
	public void initEvent(UUID event){
		...
		boolean isStarted = session.getEM().isStarted(event);
		cancel.setDisable(isStarted);
	}
