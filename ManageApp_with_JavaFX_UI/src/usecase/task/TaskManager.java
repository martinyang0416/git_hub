...
public class TaskManager implements TaskManage{
	...
	@Override
	public void removeTask(UUID person, Event event){
		taskCreate.removeTask(person, event);
	}
	
	@Override
	public void removeTasks(Collection<UUID> people, Event e){
		taskCreate.removeTasks(people, e);
	}
