...
public class TaskConvert implements TaskVisitor, Serializable{
	...
	transient private List<TaskDTO> taskDTOS;
	transient private String        ownerName;
	...
	public void visitAppointment(Appointment appointment){
		...
		taskDTO.setStartTime(appointment.getStartTime());
		taskDTO.setEndTime(appointment.getEndTime());
		taskDTO.setLocation(appointment.getLocation());
	...
	public void visitSpeakerDuty(SpeakerDuty speakerDuty){
		...
		taskDTO.setStartTime(speakerDuty.getStartTime());
		taskDTO.setEndTime(speakerDuty.getEndTime());
		taskDTO.setLocation(speakerDuty.getLocation());
		taskDTOS.add(taskDTO);
	}
}