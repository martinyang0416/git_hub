...
public class PeopleConvert implements PersonVisitor, Serializable{
	
	transient private List<PersonDTO> personDTOS;
	...
	public List<PersonDTO> convertAllSpeaker(){
		return convert(pm.getAllSpeaker());
	}
