...
import usecase.recommand.facade.PeopleRecommendConvert;
...
public class RecommendManager implements RecommendManage{
	...
	private PeopleRecommendConvert peopleRecommendConvert;
	...
	public void initialize(EventManage em, PeopleManage pm, ScoreManage sm, FriendsManage fm){
		peopleRecommendConvert = new PeopleRecommendConvert(pm);
	...
	public void updateRecommendFriends(UUID p, AttendeeDashboardPresent presenter){
		...
		// update the view
		presenter.updateRecommendFriendView(peopleRecommendConvert.convert(recommend));
	}
