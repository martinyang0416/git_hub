...
/**
 * In this algorithm, the similarity between different items in the data set is calculated by
 * using one of many similarity measures. These similarity values are used to predict
 * the scores of user item pairs that do not exist in the data set.
 *
 *
 */
